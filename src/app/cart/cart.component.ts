...
export class CartComponent implements OnInit, DoCheck {
  ...
  productFinal: Array<object> = [];
  eachProductPrice: Array<object> = []; //It contains all cart items
  count: number = 1;
  ...
  ngOnInit(): void {
    ...
    this.prices = this.cartItemsArray.map((data: any) =>
      Number(`${data.price}`)
    );
  }
  ngDoCheck(): void {
